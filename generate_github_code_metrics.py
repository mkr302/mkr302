...
def generate_horizontal_bar_charts(stats):
    ...
    axes[0].set_title("Lifetime Contributions", fontsize=14, fontweight="bold", color="white", pad=50)  # Increased spacing
    ...
    axes[1].set_title(f"Contributions in {datetime.datetime.now().year}", fontsize=14, fontweight="bold", color="white", pad=50)  # Increased spacing
